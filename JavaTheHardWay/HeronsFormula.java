public class HeronsFormula {
  public static void main(String[] args) {
    ...
    System.out.println(tws + "9,9,9" + hs + triangleArea(9, 9, 9));
  }
...
// Study Drill: using a function makes your code shorter, easier to fix, and easier to add a new triangle to (9, 9, 9) than not having a function to call on.
